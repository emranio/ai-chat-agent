...
export function loadStageAnalyzerChain(llm = BaseLanguageModel, verbose = false) {
...
export function loadSalesConversationChain(llm = BaseLanguageModel, verbose = false) {
    const prompt = new PromptTemplate({
